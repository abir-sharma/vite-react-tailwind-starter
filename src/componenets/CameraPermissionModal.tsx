...
//       <Card className="w-full max-w-md bg-white rounded-3xl p-8 relative">
//         {/* Close button */}
//         {/* <button 
//           onClick={onClose}
...
//               <div className="w-6 h-6 border-l-4 border-t-4 border-orange-400 rounded-tl-lg"></div>
//             </div>
//             <div className="absolute -top-2 -right-2">
//               <div className="w-6 h-6 border-r-4 border-t-4 border-orange-400 rounded-tr-lg"></div>
//             </div>
//             <div className="absolute -bottom-2 -left-2">
//               <div className="w-6 h-6 border-l-4 border-b-4 border-orange-400 rounded-bl-lg"></div>
//             </div>
//             <div className="absolute -bottom-2 -right-2">
//               <div className="w-6 h-6 border-r-4 border-b-4 border-orange-400 rounded-br-lg"></div>
//             </div>
//             {/* Exclamation mark */}
...
//                   onCheckedChange={(checked) => setCameraEnabled(checked as boolean)}
//                   className="border-2"
//                 />
//                 <span className="font-medium text-gray-900">Camera On</span>
//               </div>
//             </div>
...
//             <div className="flex flex-col items-center flex-1">
//               <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-3 transition-all ${
//                 !cameraEnabled ? 'bg-gray-100' : 'bg-gray-50'
//               }`}>
...
//                   className="border-2"
//                 />
//                 <span className="font-medium text-gray-900">Camera Off</span>
//               </div>
//             </div>
//           </div>
//         </div>
...
//               onCheckedChange={(checked) => setBlurBackground(checked as boolean)}
//               className="border-2"
//             />
...
//               onClick={() => console.log("distractive way")}
...
//             <button
//             disabled={!cameraEnabled}
//               onClick={() => console.log("attentive way")}
//               className={`flex-1 py-4 px-6 rounded-lg font-medium transition-all ${
//                 // learningMode === 'attentive'
//                 cameraEnabled
